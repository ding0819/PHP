...
<form action="adddb.php" method="get">
    ...
    學號：
    <input type="text" name="sID" value="" placeholder="輸入您的學號(Axxxxxxx)" required><br/>
    系所：
    <input type="radio" name="sDept" value="資管系">資管系
    <input type="radio" name="sDept" value="應經系">應經系
    <input type="radio" name="sDept" value="亞太系">亞太系
    <input type="radio" name="sDept" value="金管系">金管系<br/>
    系級：
